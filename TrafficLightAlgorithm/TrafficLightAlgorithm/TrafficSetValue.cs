namespace TrafficLightAlgorithm
{
    public struct StructTraffic
    {
        ...
        /// <returns> 新しい値が設定された構造体 </returns>
        public static StructTraffic UpdateValue(string north, string south, string east, string west, string arrow, string prepare)
        {
